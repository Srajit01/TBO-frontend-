  ...
  return (
    ...
    >
      <div className="relative">
        {/* Use the first image of the hotel as the cover photo */}
        <img
  src={hotel && hotel.Images && hotel.Images.length > 0 ? hotel.Images[0] : '/placeholder.svg'}
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-grow">
            ...
            <div className="flex items-center text-gray-600 mb-2">
              ...
              <span className="text-sm">{hotel.CityName}, {hotel.CountryName}</span>
            </div>
          </div>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap gap-2">
            {facilities.map((facility, index) => (
              <div 
                key={index}
                className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-full text-xs text-gray-700 font-bold"
              >
